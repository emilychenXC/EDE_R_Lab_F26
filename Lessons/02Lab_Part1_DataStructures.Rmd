...
#Combine vector1 and vector4 together
c(vector1, vector4)

# Multiply each number in the vector1 and vector 4 together
vector1 * vector4

# Multiply each number in the vector with 10
vector1 * 10

# Uppercase all the letter in the character in the vector
toupper(vector2) 

# Reverse the logic in the vector
!vector3
